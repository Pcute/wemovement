...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-7">
            <div class="media">
                <div class="media-left"> <a href="#"> <img class="media-object img-thumbnail" src="${longer.communityPicture}" alt="..." width="200px" height="100px"> </a> </div>
                <div class="media-body">
                    <h3 class="media-heading">社团简介</h3>
                    ${longer.communityIntro}
        ...
        <div class="col-xs-5 well">
            <div class="row">
                <div class="col-lg-6">
                    <h4><span class="glyphicon glyphicon-phone" aria-hidden="true"></span> : ${longer.tele}123-456-7890</h4>
                </div>
                <div class="col-lg-6">
                    <h4><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> :${longer.email} jxnu@163.com</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-8">
                    <h4><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> : ${longer.communityAddress}江西师范大学先骕楼x3513a</h4>
                </div>
                <div class="col-lg-4">
